...
// Mock para componentes específicos do Next.js
export const withSentryConfig = jest.fn((config) => config);
export const withSentry = jest.fn((handler) => handler);

// Mock para instrumentação
export const registerInstrumentation = jest.fn();
